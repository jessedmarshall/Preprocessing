...
if(liquidLight==0){
	...
	# analysis_dir = "C:/b/Dropbox/schnitzer/analysis/biafra/pav/p62/"
		data_dir_list = c("../../data/behavior/med_files/p104_sst","../../data/behavior/med_files/p104_pav","../../data/behavior/med_files/ding_collaboration_pav")
	analysis_dir_list = c("../../analysis/medfiles/p104_sst","../../analysis/medfiles/p104_pav","../../analysis/medfiles/ding_collaboration_pav")
}else{
...
for (dirNo in c(1:length(data_dir_list))) {
	...
	writeData(animalData,paste(analysis_dir,"../lickCount.csv",sep=""),sep=",")
	# writeData(rawMouseData,paste(analysis_dir,"mouseRaw.data",sep=""))
	# print('saving raw')
	writeDataToFile(rawMouseData,paste(analysis_dir,"../rawData.tab",sep=""))
	writeDataToFile(rawMouseData,paste(analysis_dir,"../rawData.csv",sep=""),sep=",")
