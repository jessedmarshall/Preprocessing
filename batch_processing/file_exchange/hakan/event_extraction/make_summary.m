...
%
%   sources : a struct that has as its fields the filenames for the maze 
%   data, behavior videos, miniscope videos, PCA data, and IC directory. 
%   (refer to a 'data_sources.m' file for the specifics of this struct. )
%
