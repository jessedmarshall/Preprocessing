function obj = computeMatchObjBtwnTrials(obj)
	...
	scnsize = get(0,'ScreenSize');
	userDefaults = {'1'};
	usrIdxChoice = inputdlg({'number of rounds to register images'},'options',1,userDefaults);
	...
	for thisSubjectStr=subjectList
		try
			...
			alignmentStruct = matchObjBtwnTrials(rawImages,'inputSignals',rawSignals,'trialToAlign',trialToAlign,'additionalAlignmentImages',[],'nCorrections',nCorrections);
