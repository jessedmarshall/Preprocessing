function VRiD_color_plot(v1,v2,v3,colorbarOption)
    % This file takes in at least two, single column vectors that are of equal length (three for a 3D plot) and colour codes them according to their position in the matrix, going from blue to black
    % biafra ahanonu
    % Updated: 08/05/11
    % updated: 2013.06.18
    % inputs
